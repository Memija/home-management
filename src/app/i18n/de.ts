export const de = {
    ...
    CHART: {
        ...
        COMPARISON_NOTE_CITY: 'Vergleich basiert auf {city} Durchschnitt (128 L/Person/Tag) für Familien mit {size} Mitgliedern',
    ...
    HOME: {
        ...
        DELETE_ALL_CONFIRM_MESSAGE: 'Sind Sie sicher, dass Sie alle {count} gefilterten Eintrag/Einträge löschen möchten? Diese Aktion kann nicht rückgängig gemacht werden.',
