...
const defaultFacts = {
  ...
  WORLD: [
    "71% Zemljine površine je pokriveno vodom.",
    "Oko 97% Zemljine vode je slana voda u okeanima.",
    "2.5% Zemljine vode je slatko, ali većina je smrznuta u polarnim kapama.",
    "Manje od 1% vode na planeti je dostupno ljudima za korištenje.",
