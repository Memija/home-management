...
export const asiaPacificElectricityFacts = {
  ...
  // China
  CN: [
    'Kina je najveći svjetski proizvođač solarnih panela.',
    'Kina godišnje dodaje više kapaciteta obnovljivih izvora nego bilo koja druga nacija.',
    'Ugalj i dalje obezbjeđuje većinu električne energije u Kini.',
    'Brana tri klanca je najveća elektrana na svijetu.',
    'Kina gradi masivne ultra-visokonaponske dalekovode.',
    'Kina ima najambiciozniji program izgradnje nuklearnih elektrana.',
  ...
  // India
  IN: [
    'Indija ima masivan cilj od 500 GW obnovljive energije do 2030. godine.',
    'Solarna energija je sada jeftinija od uglja u Indiji.',
  ...
  // Australia
  AU: [
    'Australija ima najveći procenat usvajanja krovnih solarnih panela na svijetu.',
    'Ugalj je i dalje značajan, ali se njegove elektrane ubrzano zatvaraju.',
    'Australija je izgradila najveću bateriju na svijetu u Južnoj Australiji.',
  ...
  // New Zealand
  NZ: [
    'Novi Zeland generiše 80–85% električne energije iz obnovljivih izvora.',
    'Hidroenergija čini okosnicu elektroenergetske mreže Novog Zelanda.',
    'Geotermalna energija je značajan izvor osnovnog opterećenja.',
    'Energija vjetra raste u vjetrovitim regijama "Roaring Forties".',
    'Novi Zeland teži 100% obnovljivoj električnoj energiji do 2030. godine.',
