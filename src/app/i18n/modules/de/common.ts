...
export const common = {
  ...
  RELEASE_PLAN: {
    ...
    FEATURE_5_DESC: 'Wir streben nach Perfektion. Unser nächstes Update zielt darauf ab, einen 100% Lighthouse-Score in den Bereichen Performance, Barrierefreiheit und SEO zu erreichen, um das reibungsloseste Erlebnis für alle zu gewährleisten.',
    FEATURE_6_TITLE: 'Code-Qualitäts-Exzellenz',
    FEATURE_6_DESC: 'Wir verpflichten uns zur Einhaltung höchster Code-Standards. Unser nächstes Release wird sich auf eine tiefere SonarCloud-Integration und die Behebung aller gemeldeten Sonar-Probleme konzentrieren.',
