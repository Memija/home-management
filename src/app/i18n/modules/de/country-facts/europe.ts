...
export const europeFacts = {
  // Germany
  DE: [
    'Deutschland recycelte 2023 über 99% seiner Plastikflaschen, die höchste Rate in Europa!',
    'Der durchschnittliche Deutsche verbraucht nur 121 Liter Wasser pro Tag zu Hause, einer der niedrigsten Werte in Industrieländern.',
    'Deutsche Haushalte zahlen etwa 2€ pro Kubikmeter Wasser, was zum Sparen anregt.',
    'Der Rhein versorgt über 30 Millionen Menschen in Deutschland mit Trinkwasser.',
    'Deutschland hat über 6.000 öffentliche Trinkwasserbrunnen in Städten.',
    'Das deutsche Reinheitsgebot stellt sicher, dass nur Wasser, Hopfen und Malz verwendet werden.',
    'Der Schwarzwald versorgt Millionen Deutsche mit natürlichem Quellwasser.',
    'Deutsche Waschmaschinen verbrauchen 50% weniger Wasser als vor 30 Jahren.',
  ...
  // Austria
  AT: [
    'Österreichisches Leitungswasser kommt direkt aus Alpenquellen und gehört zu den reinsten der Welt.',
    '50% des österreichischen Trinkwassers stammt aus Grundwasser, 50% aus Quellen.',
    'Wiener Wasser legt 100km durch Schwerkraft-Leitungen aus den Alpen zurück.',
    ...
    'Die österreichischen Alpen speichern 50% der europäischen Süßwasserreserven.',
  ],

  // Switzerland
  CH: [
    'Die Schweiz wird "Wasserschloss Europas" genannt mit 6% des europäischen Süßwassers.',
    'Schweizer Leitungswasser übertrifft oft die Qualität von Flaschenwasser.',
    'Der Genfer See enthält 89 Milliarden Kubikmeter Süßwasser.',
    'Schweizer Haushalte verbrauchen durchschnittlich 142 Liter pro Person pro Tag.',
    'Die Schweiz hat über 7.000 Seen und unzählige Flüsse.',
    'Rhône, Rhein und Po entspringen alle in der Schweiz.',
    'Schweizer Wasserwerke arbeiten ohne Gewinn und halten die Preise niedrig.',
  ...
  // Netherlands
  NL: [
    'Die Niederlande haben 17% ihres Landes dem Meer abgerungen!',
    'Niederländisches Wassermanagement machte das Land zum Weltführer in Hochwasserschutz.',
    'Amsterdams Kanäle erstrecken sich über 100km Länge.',
    'Niederländer trinken mehr Leitungswasser als jede andere europäische Nation.',
    'Die Niederlande exportieren jährlich Wassertechnologie im Wert von 4 Milliarden Euro.',
    'Niederländische Windmühlen wurden ursprünglich gebaut, um Wasser aus überfluteten Ländern zu pumpen.',
  ...
  // France
  FR: [
    'Frankreich hat über 3.000 Mineralwasserquellen, mehr als jedes andere Land.',
    'Die Franzosen verbrauchen durchschnittlich 145 Liter pro Person pro Tag.',
    'Die Seine versorgt 10 Millionen Pariser mit Wasser.',
    'Frankreich produziert jährlich 8 Milliarden Liter Flaschenwasser.',
    'Die Fontänen von Versailles nutzen 6.300 Kubikmeter Wasser pro Vorstellung.',
    'Französische Weinberge nutzen Tröpfchenbewässerung zur Wassereinsparung.',
    'Der Canal du Midi, 1681 erbaut, ist UNESCO-Weltkulturerbe.',
    'Paris hat über 1.200 Trinkbrunnen, genannt "Wallace-Brunnen".',
    'Französische Kernkraftwerke führen 98% des Kühlwassers in Flüsse zurück.',
    'Evian-Wasser braucht 15 Jahre, um durch die Alpen zu filtern.',
    'Frankreich recycelt 87% seines Industriewassers.',
    'Die Camargue-Feuchtgebiete filtern natürlich Wasser für Südfrankreich.',
  ],

  // United Kingdom
  GB: [
    'Londoner Wasser wurde bis zu 8 Mal recycelt, bevor es das Meer erreicht!',
    'Das Vereinigte Königreich hat durchschnittlich 156 Regentage pro Jahr.',
    'Britische Wasserunternehmen verwalten 347.000km Wasserleitungen.',
    'Der durchschnittliche britische Haushalt verbraucht 349 Liter Wasser pro Tag.',
    'Thames Water versorgt 15 Millionen Kunden in London.',
    'Schottland hat über 30.000 Süßwasserseen.',
  ...
  // Italy
  IT: [
    'Roms antike Aquädukte versorgen noch heute 10% der Stadt mit Wasser!',
    'Italien hat 27.000km Küstenlinie, umgeben vom Mittelmeer.',
    'Italiener verbrauchen durchschnittlich 175 Liter pro Person pro Tag.',
    'Venedig ist auf 118 kleinen Inseln gebaut, verbunden durch 400 Brücken.',
    'Italiens Thermalbäder gehen auf die Römerzeit zurück.',
    'Der Po bewässert das landwirtschaftliche Herzland Norditaliens.',
  ...
  // Spain
  ES: [
    'Spanien ist der größte Nutzer von entsalztem Wasser in Europa!',
    'Der durchschnittliche Spanier verbraucht 132 Liter Wasser pro Tag zu Hause.',
    'Spanien hat über 1.200 Entsalzungsanlagen entlang seiner Küste.',
    'Das Guadalquivir-Becken bewässert Südspaniens Olivenhaine.',
  ...
  // Belgium
  BE: [
    'Belgien hat bemerkenswert hohe Wasserqualität aus tiefem Grundwasser.',
    'Die berühmte belgische Braukunst erfordert reinstes Wasser.',
    'Belgische Haushalte verbrauchen etwa 96 Liter pro Person pro Tag.',
    'Brügge wird wegen seiner Kanäle "Venedig des Nordens" genannt.',
    'Belgisches Leitungswasser erfüllt über 50 Qualitätsparameter.',
    'Die Maas versorgt Millionen mit Wasser.',
  ...
  // Ireland
  IE: [
    'Irland erhält jährlich über 1.000mm Niederschlag!',
    'Der Shannon ist der längste Fluss in Irland und dem UK.',
    'Irische Haushalte verbrauchen etwa 130 Liter pro Person pro Tag.',
    'Dublins Wasser stammt aus Stauseen in den Wicklow Mountains.',
  ...
  // Norway
  NO: [
    'Norwegen hat mehr Süßwasser pro Kopf als fast jedes andere Land!',
    'Die Fjorde des Landes enthalten einige der reinsten Gewässer der Welt.',
    'Norwegische Haushalte verbrauchen etwa 180 Liter pro Person pro Tag.',
  ...
  // Denmark
  DK: [
    'Dänemark hat das effizienteste Wassersystem in Europa!',
    'Dänische Haushalte verbrauchen nur 104 Liter pro Person pro Tag.',
    'Das Land verliert nur 7% des Wassers durch Lecks, weltweit am niedrigsten.',
    'Kopenhagens Wasser stammt vollständig aus Grundwasser.',
    'Dänemark verbot 1998 Pestizide in der Nähe von Wasserquellen.',
    'Die Kleine Meerjungfrau-Statue sitzt im Kopenhagener Hafen.',
    'Dänische Wasserunternehmen reinvestieren 100% der Gewinne in die Infrastruktur.',
    'Das Land hat 7.300km Küstenlinie für so eine kleine Nation.',
  ...
  // Finland
  FI: [
    'Finnland hat 188.000 Seen - das ist ein See pro 26 Einwohner!',
    'Finnisches Leitungswasser ist oft sauberer als Flaschenwasser.',
    'Helsinkis Wasser kommt aus dem 120km entfernten Päijänne-See.',
    'Finnen verbrauchen etwa 140 Liter Wasser pro Person pro Tag.',
    'Das Land hat mehr Wasserfläche als jede andere europäische Nation.',
    'Finnische Saunen verbrauchen 80 Liter Wasser pro Sitzung.',
  ...
  // Czech Republic
  CZ: [
    'Tschechien ist berühmt für sein Bier, das reines Wasser benötigt!',
    'Tschechen verbrauchen nur 89 Liter pro Person pro Tag, niedrigster Wert in der EU.',
    'Prag liegt an der Moldau, Tschechiens längstem Fluss.',
    'Das Land hat über 20.000 Teiche, viele mittelalterlich.',
    'Tschechische Mineralquellen werden seit Jahrhunderten therapeutisch genutzt.',
    'Karlsbad hat 13 Hauptheißquellen für Kurbehandlungen.',
    'Das Land exportiert renommiertes tschechisches Kristall und Glas.',
    'Tschechien hat 70.000km Bäche und Flüsse.',
  ...
  // Hungary
  HU: [
    'Ungarn hat über 1.300 Thermalquellen - mehr als jedes andere europäische Land!',
    'Budapests Thermalbäder werden seit der Römerzeit genutzt.',
    'Der Balaton ist Mitteleuropas größter Süßwassersee.',
    'Ungarn verbraucht etwa 100 Liter pro Person pro Tag.',
    'Die Donau durchfließt Ungarn auf 417km.',
    'Hévíz ist der weltweit größte Thermalsee.',
  ...
  // Romania
  RO: [
    'Rumänien hat 3.450 Gletscherseen in den Karpaten!',
    'Die Donau bildet 1.075km von Rumäniens Südgrenze.',
    'Rumänen verbrauchen etwa 120 Liter pro Person pro Tag.',
    'Das Donaudelta ist Europas größtes Feuchtgebiet.',
    'Rumänien hat über 160 therapeutische Mineralquellen.',
  ...
  // Slovenia
  SI: [
    'Slowenien hat 27 Flüsse und über 300 Wasserfälle!',
    'Die Soča ist berühmt für ihre atemberaubende Smaragdfarbe.',
    'Slowenen verbrauchen etwa 98 Liter pro Person pro Tag.',
    'Slowenien hat 65% Waldbedeckung, die Wasser natürlich filtert.',
    'Der Bleder See wird von Thermalquellen gespeist.',
    'Das Land hat 87 natürliche Quellen.',
    'Das Höhlensystem Postojna hat unterirdische Flüsse.',
  ...
  // Slovakia
  SK: [
    'Die Slowakei hat über 1.600 Mineralquellen!',
    'Slowaken verbrauchen nur 78 Liter pro Person pro Tag, sehr effizient.',
    'Die Hohe Tatra hat über 100 Bergseen.',
    'Slowakische Thermalquellen ziehen Wellness-Tourismus an.',
    'Die Donau fließt durch Bratislava.',
    'Das Kurbad Piešťany nutzt seit über 200 Jahren Thermalwasser.',
  ...
  // Serbia
  RS: [
    'Serbien hat über 300 Thermalquellen!',
    'Die Donau durchfließt Serbien auf 588km.',
    'Serben verbrauchen etwa 88 Liter pro Person pro Tag.',
    'Vrnjačka Banja ist Serbiens ältester Kurort.',
    'Die Drina ist berühmt für ihr smaragdfarbenes Wasser.',
    'Serbien hat 6 große Flussbecken.',
  ...
  // Montenegro
  ME: [
    'Montenegros Tara-Schlucht ist mit 1.300m Europas tiefste!',
    'Die Tara wird wegen ihrer Reinheit "Träne Europas" genannt.',
    'Montenegriner verbrauchen etwa 95 Liter pro Person pro Tag.',
    'Der Skutarisee ist der größte See des Balkans.',
  ...
  // North Macedonia
  MK: [
    'Nordmazedonien hat drei große tektonische Seen!',
    'Der Ohridsee ist einer der ältesten und tiefsten Seen Europas.',
    'Mazedonier verbrauchen etwa 85 Liter pro Person pro Tag.',
    'Der Ohridsee ist 1,36 Millionen Jahre alt.',
    'Der Vardar versorgt Skopje mit Wasser.',
    'Nordmazedonien hat 16 natürliche Thermalquellen.',
    'Der Prespasee wird mit Albanien und Griechenland geteilt.',
    'Das Land hat 1.100 natürliche Quellen.',
  ...
  // Albania
  AL: [
    'Albanien hat 152 Flüsse, die in die Adria und das Ionische Meer münden!',
    'Die Blaue-Auge-Quelle produziert 18.400 Liter pro Sekunde.',
    'Albaner verbrauchen etwa 90 Liter pro Person pro Tag.',
    'Der Shkodrasee ist der größte See des Balkans.',
    'Albanien hat massives Wasserkraftpotenzial.',
    'Die Vjosa ist Europas letzter großer wilder Fluss.',
    'Die Albanischen Alpen haben unzählige Gletscherseen.',
  ...
  // Kosovo
  XK: [
    'Kosovo hat reichliche Süßwasserressourcen aus Bergen!',
    'Der Weiße Drin entspringt im Kosovo.',
    'Kosovaren verbrauchen etwa 75 Liter pro Person pro Tag.',
    'Das Skigebiet Brezovica hat makelloses Bergwasser.',
    'Die Mirusha-Wasserfälle haben 13 Seen.',
    'Kosovo hat bedeutende Grundwasserreserven.',
    'Die Bistrica fließt durch Pristina.',
    'Kosovos Sharr-Gebirge liefert natürliche Quellen.',
