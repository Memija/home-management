...
export const errors = {
  ERROR: {
    ...
    CLOSE: 'Schließen',
    EXCEL_DATE_FIX_1:
      'Stellen Sie sicher, dass Datumsangaben im Format TT.MM.JJJJ vorliegen (z.B. 14.09.2025)',
    ...
    EXCEL_COLUMN_FIX_1:
      'Überprüfen Sie, ob Ihre Excel-Spaltennamen mit den in den Einstellungen konfigurierten Namen übereinstimmen',
    EXCEL_COLUMN_FIX_2:
      'Gehen Sie zu Einstellungen → Excel-Integration, um die Spaltenzuordnungen anzuzeigen oder zu aktualisieren',
    EXCEL_GENERIC_FIX_1: 'Überprüfen Sie, ob Ihre Excel-Datei im .xlsx-Format vorliegt',
    EXCEL_GENERIC_FIX_2:
      'Stellen Sie sicher, dass alle erforderlichen Spalten mit korrekten Datentypen vorhanden sind',
    ...
    JSON_DATE_FIX_1:
      'Stellen Sie sicher, dass Datumsangaben im ISO-Format vorliegen (z.B. 2025-09-14T00:00:00.000Z)',
    ...
    IMPORT_INVALID_ROOM_VALUE:
      "Datensatz ({{date}}): Ungültige Zahl '{{value}}' für Raum '{{room}}'",
    ...
    IMPORT_DUPLICATE_DATE:
      "Datensatz {{row}}: Doppeltes Datum '{{date}}' (erstes Vorkommen in Datensatz {{firstRow}})",
    IMPORT_INVALID_NUMBER_VALUE:
      "Datensatz {{row}}: Ungültiger Zahlenwert '{{value}}' für Feld '{{field}}'",
    ...
    IMPORT_INVALID_EXCEL_FILE_TYPE:
      'Ungültiger Dateityp. Erwartet wurde eine Excel-Datei (.xlsx, .xls, .csv), erhalten wurde {{extension}}',
    IMPORT_EXCEL_MISSING_DATE_COLUMN:
      'Fehlende erforderliche Datumsspalte: {{column}}. Bitte überprüfen Sie Ihre Excel-Datei.',
  },
};
