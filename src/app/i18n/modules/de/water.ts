...
export const water = {
  ...
  HOME: {
    ...
    RECORDS_HELP_STEP_2_DESC: 'Verwenden Sie die Datumsauswahl, Jahres- und Monatsfilter. Sie können auch nach Datum oder Verbrauchswerten sortieren.',
    ...
    RECORDS_HELP_STEP_4_DESC: 'Exportieren Sie Ihre Daten als Backup oder importieren Sie Daten aus JSON- oder Excel-Dateien.',
