...
export const common = {
  ...
  METER_READER: {
    ...
    UPLOAD_HINT: 'From your gallery',
    CAPTURE: 'Capture',
    PROCESSING: 'Reading meter numbers...',
    DETECTED_VALUE: 'Detected Reading',
    EDIT_HINT: 'You can edit the value if needed',
    OTHER_VALUES: 'Other detected values:',
    NO_VALUE_FOUND: 'No numbers could be detected. Please try again with a clearer image.',
    RETRY: 'Try Again',
    USE_VALUE: 'Use This Value',
    SELECT_FIELD: 'Which meter does this reading belong to?',
    CROP_INSTRUCTION: 'Please crop the image to show only the digits for better accuracy.',
    CROP_DRAG_HINT: 'Click and drag to draw a selection around the meter digits.',
    CROP_SELECTED: 'Selection ready — click Scan Selection to read.',
    SKIP_CROP: 'Use Full Image',
    SCAN_SELECTION: 'Scan Selection',
    SCAN_FULL: 'Scan Full Image',
  ...
  PREDICTIONS: {
    ...
    MIN: 'Min',
    MAX: 'Max',
    PREDICTED_DAILY: 'Predicted Daily',
