...
export const common = {
  ...
  NOTIFICATIONS: {
    ...
    HEATING_OVERDUE_MESSAGE: 'It has been {{days}} days since your last heating reading. Add a new entry to keep your data up to date.',
    ...
    ELECTRICITY_INITIAL_MESSAGE: 'Add your first meter reading to start tracking your electricity consumption.',
    ELECTRICITY_OVERDUE_TITLE: 'Time to Add an Electricity Reading',
    ELECTRICITY_OVERDUE_MESSAGE: 'It has been {{days}} days since your last electricity reading. Add a new entry to keep your data up to date.',
    ELECTRICITY_DUE_TITLE: 'Time for Your Electricity Reading',
    ELECTRICITY_DUE_MESSAGE: "Based on your schedule, it's time to take an electricity meter reading.",
  ...
  SMART_IMPORT: {
    ...
    INSTRUCTION: 'Copy the table content from the website and paste it here. We will extract the dates and values automatically.',
    PLACEHOLDER: 'Paste your text here... (Example: 01/01/2023   1,234 kWh)',
    FOUND: 'Records Found',
    DATE: 'Date',
    VALUE: 'Value (kWh)',
    NO_DATA_FOUND: 'No valid data could be found in the pasted text. Please try copying a different format.',
