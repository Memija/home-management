// Africa electricity facts - English
export const africaElectricityFacts = {
  ...
  EG: [
    ...
    'Egypt is building a nuclear power plant at El Dabaa.',
    'Interconnectors to Europe and Saudi Arabia are planned.',
  ...
  // Nigeria
  NG: [
    'Nigeria suffers from chronic power shortages.',
    'Most businesses and homes rely on diesel generators.',
    'The grid serves only a fraction of the population effectively.',
    'Nigeria is reforming its power sector to attract investment.',
    'Solar mini-grids are bringing power to rural areas.',
    'Hydropower and gas are the main grid sources.',
    'Access to electricity is a major political issue.',
    'Nigeria aims to electrify 25 million people with solar.',
  ...
  // Morocco
  MA: [
    'Morocco imports energy but is building massive renewables.',
    'The Noor Ouarzazate complex is a giant solar plant.',
    'Morocco aims for 52% renewable capacity by 2030.',
    'Wind power is abundant on the Atlantic coast.',
    'Morocco exports electricity to Spain.',
    'Coal and gas are still used for baseload.',
    'Rural electrification reaches over 99%.',
    'Morocco has no oil or gas of its own.',
