// Americas electricity facts - English
export const americasElectricityFacts = {
  // USA
  US: [
    'The US is the second largest producer of electricity in the world.',
    'Natural gas is the largest source of electricity in the US.',
    'Renewables generated 20% of US electricity in 2020.',
    'The US grid is actually three separate major grids.',
    'California generates a huge surplus of solar power during the day.',
    'Texas leads the US in wind power generation.',
    'The Hoover Dam is one of the most famous hydro plants.',
    'Nuclear power provides 20% of US electricity.',
  ...
  // Canada
  CA: [
    'Canada produces 60% of its electricity from hydropower.',
  ...
  // Mexico
  MX: [
    'Mexico generates most of its electricity from natural gas.',
    'Mexico has excellent solar potential in the north.',
    'Geothermal energy is a significant resource in Mexico.',
    'Mexico aims to generate 35% clean energy by 2024.',
    'Hydroelectric dams power much of southern Mexico.',
    'Wind farms in Oaxaca have world-class capacity factors.',
  ...
  AR: [
    ...
    'Argentina has suffered from blackouts in the past.',
    'Electricity subsidies have kept prices low for consumers.',
    'Renewable energy auctions have attracted investment.',
