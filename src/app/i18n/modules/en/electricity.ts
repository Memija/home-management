export const electricity = {
  ELECTRICITY: {
    ...
    DELETE_CONFIRM_MESSAGE:
      'Are you sure you want to delete this electricity record? This action cannot be undone.',
    ...
    RECORD_HELP_STEP_1_DESC:
      'Tracking electricity usage helps you identify high-consumption periods, optimize your energy efficiency, and lower your bills.',
    RECORD_HELP_STEP_2_TITLE: 'Select Date',
    RECORD_HELP_STEP_2_DESC:
      'Choose the date of the meter reading. Regular readings (e.g., monthly) give the best insights.',
    ...
    RECORD_HELP_STEP_4_DESC:
      'Click Save to store the record. The date field will reset to allow for quick entry of multiple records.',
    // Chart Help
    CHART_HELP_STEP_1_TITLE: 'What the Chart Shows',
    CHART_HELP_STEP_1_DESC:
      'The chart visualizes your electricity consumption in kWh over time. It helps you identify high-usage periods and trends.',
    CHART_HELP_STEP_2_TITLE: 'Display Modes',
    CHART_HELP_STEP_2_DESC:
      'Switch between "Total Cumulative Meter Reading" (your raw meter values) and "Daily Average Consumption" (calculated average usage per day between readings).',
    CHART_HELP_STEP_3_TITLE: 'Comparison',
    CHART_HELP_STEP_3_DESC:
      'In Daily Average mode, enable "Show Average" to compare your household usage against the national average for a household of your size.',
    CHART_HELP_STEP_4_TITLE: 'Interaction',
    CHART_HELP_STEP_4_DESC:
      'Use mouse wheel or pinch gesture to zoom in/out. Drag to pan across the timeline. Click "Reset Zoom" to return to the full view.',
    // Detailed Records Help
    RECORDS_HELP_STEP_1_TITLE: 'Filtering Records',
    RECORDS_HELP_STEP_1_DESC:
      'Use the date range, year, or month filters to find specific electricity records. Click "Reset Filters" to clear all active filters and view all records.',
    RECORDS_HELP_STEP_2_TITLE: 'Sorting & Pagination',
    RECORDS_HELP_STEP_2_DESC:
      'Sort records by date or usage value using the dropdown. Control how many records to display per page (5, 10, 20, or 50) and navigate using Previous/Next buttons.',
    ...
    RECORDS_HELP_STEP_4_DESC:
      'Export your data as JSON, Excel, or PDF files. Import previously exported JSON or Excel files to restore your electricity consumption records. Only non-zero records are imported.',
    RECORDS_HELP_STEP_5_TITLE: 'Smart Import',
    RECORDS_HELP_STEP_5_DESC:
      'Use Smart Import to paste data directly from spreadsheets or text. It automatically detects dates and meter readings, letting you preview and confirm before importing.',
