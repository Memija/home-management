...
export const water = {
  ...
  HOME: {
    ...
    CHART_HELP_STEP_2_DESC: 'Switch between Total (cumulative readings) and Incremental (daily consumption) views to see different perspectives.',
    CHART_HELP_STEP_3_TITLE: 'View Options',
    CHART_HELP_STEP_3_DESC: 'Use the filter buttons to view Total consumption, By Room (Kitchen/Bathroom), By Type (Warm/Cold), or Detailed breakdown.',
    CHART_HELP_STEP_4_TITLE: 'Comparison Features',
    CHART_HELP_STEP_4_DESC: 'Enable trendline to see consumption trends, or compare with country averages when using incremental mode.',
    ...
    RECORDS_HELP_STEP_2_DESC: 'Use the date picker, year, and month filters to find specific records. You can also sort records by date or consumption values.',
    ...
    RECORDS_HELP_STEP_4_DESC: 'Export your data for backup or import data from JSON or Excel files using the action buttons.',
