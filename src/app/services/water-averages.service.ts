...
export class WaterAveragesService {
  ...
  private readonly countryData: Record<string, CountryWaterData> = {
    ...
    france: {
      ...
      source: "Observatoire des services publics d'eau",
      year: 2020,
    },
    ...
    finland: {
      averageLitersPerPersonPerDay: 140,
      source: 'Finnish Water Utilities Association',
      year: 2021,
    },
    ireland: { averageLitersPerPersonPerDay: 129, source: 'Irish Water', year: 2021 },
    'czech republic': {
      averageLitersPerPersonPerDay: 89,
    ...
    serbia: {
      averageLitersPerPersonPerDay: 88,
    ...
    ethiopia: {
      averageLitersPerPersonPerDay: 20,
      source: 'Ministry of Water Ethiopia',
      year: 2019,
    },
    ...
    // Oceania
    australia: {
      averageLitersPerPersonPerDay: 340,
